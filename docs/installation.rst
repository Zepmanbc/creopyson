...
The sources for Creopyson can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/Zepmanbc/creopyson
.. _tarball: https://github.com/Zepmanbc/creopyson/tarball/master
